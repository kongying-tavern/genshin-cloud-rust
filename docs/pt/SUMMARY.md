...
> **Português** translation is in progress. The complete table of contents is
...
- [Commit Convention](../en/guides/commit-message-convention.md)
- [Java Sync Roadmap](../en/guides/sync-with-java-roadmap.md)
- [Domain Sync Template](../en/guides/domain-sync-template.md)

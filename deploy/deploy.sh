...
#
# 用法：
#   ./deploy.sh [镜像tag]      # 默认 latest；回滚可传 sha-xxxxx / v1.2.3
#
# 说明：在 deploy/ 目录执行；.env 与本脚本同目录。
...
echo "[INFO] 拉取镜像 ghcr.io/langyo/genshin-cloud-rust:${TAG} ..."
docker pull "ghcr.io/langyo/genshin-cloud-rust:${TAG}"

echo "[INFO] 部署 IMAGE_TAG=${TAG} ..."
